    ...
    <div className="min-h-screen pt-24 pb-12 px-6" style={{
      ...
      <div className="container mx-auto max-w-6xl">
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
          <Button variant="ghost" onClick={onBack} className="mb-6 text-foreground hover:bg-foreground/5">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full border border-border bg-foreground/5 mb-4">
            <Beaker className="w-8 h-8 text-foreground" strokeWidth={1.5} />
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <Card className="border border-border bg-card shadow-lg p-6 space-y-6 text-card-foreground">
            ...
            <div className="grid gap-4">
                  ...
                  {selectedMethod && (
                    <div className="mt-2 text-xs text-muted-foreground">
                      ...
                      {selectedMethod.recommendation && (
                        <p className="mt-1 text-muted-foreground">{selectedMethod.recommendation}</p>
                      )}
                    </div>
                  )}
                </div>
              ...
              {operation !== "embed" && (
                <div>
                  <label className="text-sm text-foreground block mb-2">{operation === "extract" ? "Stego File" : "Artifact"}</label>
                  <FileUpload
              ...
              <div>
                ...
                />
                <p className="text-xs text-muted-foreground mt-1">Leave blank for defaults. Options map directly to backend kwargs.</p>
              </div>
            </div>
          ...
          <Card className="border border-border bg-card shadow-lg p-6 space-y-6 text-card-foreground">
            ...
            {download && downloadUrl && (
              <div className="rounded-lg border border-border bg-muted p-4 flex flex-col gap-3">
                ...
                {previewText && (
                  <div className="rounded-md border border-border bg-background p-3 text-xs max-h-40 overflow-auto whitespace-pre-wrap">
                    {previewText}
                  </div>
                )}
              </div>
        ...
        <div className="mt-8 grid lg:grid-cols-3 gap-4">
          <Card className="p-5 border border-border bg-card shadow-md text-card-foreground">
